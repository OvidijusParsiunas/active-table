...
export class ResetColumnStyles {
  public static applyDefaultStyles(columnElements: HTMLElement[], columnsSettings: DefaultColumnsSettings) {
  ...
  public static setDefaultStyle(columnDetails: ColumnDetailsT, processedStyle: CellProcessedTextStyle,
      textContainerElement: HTMLElement, columnsSettings: DefaultColumnsSettings, oldCellStyle?: NoDimensionCSSStyle) {
