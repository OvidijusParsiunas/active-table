...
export interface FrameComponentsDisplayProps {
...
export interface FrameComponentsStyleProps {
...
export type FrameComponents = FrameComponentsStyleProps & FrameComponentsDisplayProps;
