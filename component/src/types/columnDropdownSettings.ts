...
export interface ColumnDropdownSettings {
  ...
  // please note that when this is true and the user pastes CSV data before this column - instead of overwriting proceeding
  // columns - new ones will instead be inserted before the subject column, also if the user pastes data on
  // it - no proceeding columns will be overwritten and no new ones will be inserted
