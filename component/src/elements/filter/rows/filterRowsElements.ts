...
export class FilterRowsElements {
  ...
  public static create(at: ActiveTable, outerContainers: OuterContainers) {
    ...
    if (typeof at.filter === 'boolean' || at.filter?.dropdown !== false) {
      const dropdownElement = FilterRowsDropdownElement.create(at, containerElement);
    ...
    OuterContainerElements.addToContainer(FilterRowsElements.DEFAULT_INPUT_POSITION, outerContainers, containerElement);
  }
}
