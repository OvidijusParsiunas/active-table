  ...
  public static readonly ITEMS: DropdownButtonItemSettings[] = [
    {
      ...
      iconSettings: {
        ...
        containerStyles: {dropdown: {marginRight: '1px', marginTop: '1px'}},
      },
    },
    {
      text: 'Insert Down',
    ...
    },
    {
      ...
      iconSettings: {
        ...
        containerStyles: {dropdown: {marginRight: '8px', marginTop: '1px'}},
      },
    },
    {
      text: 'Move Down',
      iconSettings: {
        ...
        containerStyles: {dropdown: {marginLeft: '2px', marginRight: '6px', marginTop: '1px'}},
      },
    },
    {
      text: 'Delete',
      iconSettings: {
        ...
        containerStyles: {dropdown: {marginLeft: '-4px', marginRight: '5px'}},
      },
    },
  ];
}
