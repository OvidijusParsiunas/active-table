...
export class ColumnDropdownButtonItemConf {
  public static readonly ITEMS: DropdownButtonItemSettings[] = [
    ...
    },
    {
      ...
      iconSettings: {svgString: SORT_DESC_ICON_SVG_STRING, containerStyles: {dropdown: {marginRight: '9px'}}},
    },
    {
      text: 'Insert Left',
      iconSettings: {
    ...
    },
    {
      ...
      iconSettings: {
        ...
        containerStyles: {dropdown: {marginLeft: '1px', marginRight: '7px', marginTop: '1px'}},
      },
    },
    {
      text: 'Move Right',
