...
export class CategoryDropdownItemEvents {
  ...
  private static highlightItem(color: string, dropdown: CategoryDropdownT, event: MouseEvent) {
    ...
    CategoryDropdownItemEvents.scrollToItemIfNeeded(itemElement, scrollbarPresence.horizontal, dropdownElement, event);
  ...
  public static set(itemElement: HTMLElement, color: string, dropdown: CategoryDropdownT) {
    itemElement.onmouseenter = CategoryDropdownItemEvents.highlightItem.bind(this, color, dropdown);
