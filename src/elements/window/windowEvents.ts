...
// this is not called when clicked on the component
export class WindowEvents {
  ...
  public static onMouseDown(this: EditableTableComponent, event: MouseEvent) {
    ...
    const {overlayElementsState: { columnDropdown, categoryDropdown }, focusedCategoryDropdown } = this
    ...
    }else if (focusedCategoryDropdown.element) {
