...
export class AddNewColumnEvents {
  ...
  // REF-17
  public static toggleBackground(columnGroup: HTMLElement, backgroundAction: 'highlight' | 'fade') {
  ...
  public static setEvents(etc: EditableTableComponent, cellElement: HTMLElement): void {
    ...
    cellElement.onmouseenter = AddNewColumnEvents.toggleBackground.bind(this, columnGroup, 'highlight');
    cellElement.onmouseleave = AddNewColumnEvents.toggleBackground.bind(this, columnGroup, 'fade');
