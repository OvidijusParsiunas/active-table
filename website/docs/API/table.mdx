...
- Type: {<br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`style?: HoverableStyles`](./types#HoverableStyles), <br />
  &nbsp;&nbsp;&nbsp;&nbsp; `inheritHeaderColors?: boolean` <br />
  }
- Default: _{ inheritHeaderColors: false }_

Frame components are the index column, add new column and the add new row. This property is used to set their styling. <br />
The `style` property defines components' styling for different mouse states. <br />
