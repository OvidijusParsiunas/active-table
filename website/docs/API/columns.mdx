...
it will be automatically set to _true_ and the index width will be set back to the initial width.
...
This object also serves as the default style for frame component styles (except for `width`) WORK. <br />
