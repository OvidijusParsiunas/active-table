...
- Type: {<br />
  ...
  &nbsp;&nbsp;&nbsp;&nbsp; [`select?: boolean|SelectDropdown<SelectOptions>`](#SelectDropdown), WORK <br />
...
- Type: {<br />
  &nbsp;&nbsp;&nbsp;&nbsp; `dropdownStyle?: SelectDropdownStyle` WORK, <br />
  &nbsp;&nbsp;&nbsp;&nbsp; `optionStyle?: {textColor: string}`, <br />
  &nbsp;&nbsp;&nbsp;&nbsp; `options?: SelectOptions|LabelOptions` WORK, <br />
  &nbsp;&nbsp;&nbsp;&nbsp; `canAddMoreOptions?: boolean` <br />
  }
- Default: {<br />
  &nbsp;&nbsp;&nbsp;&nbsp; _canAddMoreOptions: true or if `options` property is set then false_ <br />
  }

Dropdown customization properties for `select` and `label` in the [`ColumnType`](#ColumnType) object. <br />
`dropdownStyle` and `optionStyle` are used to apply specific dropdown styling aspects. <br />
`options` property defines custom options within the dropdown and uses the `SelectOptions` type to define individual options when used for a `select` dropdown
and `LabelOptions` if used for `label`. <br />
...
<TableContainer>
  <active-table
      ...
      "customColumnTypes":[
        {
          ...
          "select": {
            ...
            "options": ["Elephant", "Tiger", "Girafee"],
    ...
    content='[
      ...
      ["Elephant", "Girafee", "Elephant", "Girafee", "Tiger"],
      ["Tiger", "Elephant", "Tiger", "Tiger", "Girafee"],
      ["Girafee", "Tiger", "Invalid animal", "Elephant", "Invalid animal"],
      ["Invalid animal", "Tiger", "Girafee", "Invalid animal", "Tiger"]]'
    tableStyle='{"width":"100%", "boxShadow": "rgb(172 172 172 / 17%) 0px 0.5px 1px 0px", "borderRadius":"2px"}'
  ></active-table>
</TableContainer>
