...
`select`, `label`, `calendar` and `checkbox` properties facilitate unique features and if
more than one of these is defined - the first available one will be used in that order.
