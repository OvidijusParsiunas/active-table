...
Styling details for header elements in default state and when they are hovered by the mouse.
...
This object also serves as the default style for index column, add new column and add new row components. <br />
