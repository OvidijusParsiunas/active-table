...
Styling details for the header elements in default state and when they are hovered by the mouse. To enable the frame
component columns (index and add new column) to inherit the header style, set `inheritHeaderColors` property
in [`frameComponentsStyle`](./table#frameComponentsStyle) to _true_.
...
### `defaultActiveTypeName` {#defaultActiveTypeName}
...
- Type: {<br />
  ...
  &nbsp;&nbsp;&nbsp;&nbsp; [`availableDefaultColumnTypes?: DEFAULT_COLUMN_TYPES[]`](#DEFAULT_COLUMN_TYPES), <br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`customColumnTypes?: ColumnType[]`](#ColumnType), <br />
  &nbsp;&nbsp;&nbsp;&nbsp; `defaultActiveTypeName?: string`, <br />
...
<TableContainer>
  <active-table
    customColumnsSettings='[
      ...
      { "headerName": "Number", "cellStyle": {"backgroundColor": "#fdfdfd"}, "defaultActiveTypeName": "number", "isHeaderTextEditable": false },
      { "headerName": "Shape", "cellStyle": {"backgroundColor": "#f8f8f8"}, "defaultActiveTypeName": "Select", "isHeaderTextEditable": false },
      { "headerName": "Date Created", "cellStyle": {"backgroundColor": "#f1f1f1"}, "defaultActiveTypeName": "Date d-m-y", "isHeaderTextEditable": false }
    ]'
    content='[
...
Shared property types related to the column:
...
<TableContainer>
  <active-table
    ...
    defaultActiveTypeName="Custom type"
    content='[
...
<TableContainer>
  <active-table
    ...
    defaultActiveTypeName="Custom select type"
    content='[
...
<TableContainer>
  <active-table
    ...
    defaultActiveTypeName="Custom label type"
    content='[
      ["Animal 1", "Animal 2", "Animal 3", "Animal 4", "Animal 5"],
      ["Elephant", "Giraffe", "Elephant", "Giraffe", "Tiger"],
      ["Tiger", "Elephant", "Tiger", "Tiger", "Giraffe"],
...
<TableContainer>
  <active-table
    ...
    defaultActiveTypeName="Custom d/m/y type"
    content='[
...
<TableContainer>
  <active-table
    ...
    defaultActiveTypeName="Custom checkbox type"
    content='[
