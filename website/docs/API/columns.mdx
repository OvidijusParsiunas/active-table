...
- Default: _if this object is not provided, cells will be sorted in the ASCII character order using the "Text" type sorting functionality_
...
- Type: {<br />
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;}}
- Default: _if this object is not provided, `reusableIconName` will be set to "Text"_
