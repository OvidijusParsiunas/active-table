...
`headerIconStyle` is used to overwrite the style of the header icon if present ([`displayHeaderIcons`](./header#displayHeaderIcons)). <br />
...
:::info
These styles are automatically applied to the data and the header cells, if you wish to set the header cell style please use
the `headerStyles` property of the [`ColumnSettings`](#ColumnSettings) object.
:::
