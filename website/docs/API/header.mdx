...
[`ColumnSettings` -> `defaultText`](./columns#ColumnSettings).
...
### `displayIconsInHeaders` {#displayIconsInHeaders}
...
```text
<active-table displayIconsInHeaders="false"></active-table>
```
