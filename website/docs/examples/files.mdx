...
If you are using `TypeScript`, add this to your file:
...
ruled out the idea of bundling it into our project as it would effectively double its size. <br />
...
extra configuration to make them work. <br />
...
[`xlsx`](https://www.npmjs.com/package/xlsx) in their hands and allow them to tailor the configuration to their specific setup.
