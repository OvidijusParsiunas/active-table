...
Make sure to use the `active-table-react` package and define the element tag as `ActiveTable`. [Troubleshooting](https://github.com/OvidijusParsiunas/active-table/issues?q=React).

[Click for Live Example](https://stackblitz.com/edit/deep-chat-react-bjtflv?file=src%2FApp.tsx)
...
Everything should work right out of the box for Svelte versions `4.2.2` or above. For older versions the only difference is that values for
properties using camel cased names (camelCase) will need to be stringified.

[Click for Live Example - Svelte](https://stackblitz.com/edit/vitejs-vite-cm6j23?file=src%2FApp.svelte) <br />
[Click for Live Example - SvelteKit](https://codesandbox.io/p/sandbox/active-table-sveltekit-forked-fy9wlf)
...
[Click for Live Example](https://codesandbox.io/p/devbox/deep-chat-solidjs-forked-ngxphz)
...
the existing examples; please see [**github issues**](https://github.com/OvidijusParsiunas/active-table/issues) or create
