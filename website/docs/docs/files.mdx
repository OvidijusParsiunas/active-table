...
- Type: {fileName?: string, [`format?: FileFormat`](#FileFormat)}
...
<TableContainer minHeight="380">
  <ActiveTable
    files={{
      buttons: [
        {export: {fileName: 'example_csv', format: 'csv'}, text: 'Export CSV'},
        {export: {fileName: 'example_xls', format: 'xls'}, text: 'Export XLS'},
        {export: {fileName: 'example_xlsx', format: 'xlsx'}, text: 'Export XLSX'},
        {export: {fileName: 'example_ods', format: 'ods'}, text: 'Export ODS'},
        {export: {fileName: 'example_txt', format: 'txt'}, text: 'Export TXT'},
      ],
    }}
    content={[
      ['Planet', 'Diameter', 'Mass', 'Moons', 'Density'],
...
<active-table
  files='{
    "buttons": [
      {"export": {"fileName": "example_csv", "format": "csv"}},
      {"export": {"fileName": "example_xls", "format": "xls"}},
      {"export": {"fileName": "example_xlsx", "format": "xlsx"}},
      {"export": {"fileName": "example_ods", "format": "ods"}},
      {"export": {"fileName": "example_txt", "format": "txt"}}
  ]}'
></active-table>
```
