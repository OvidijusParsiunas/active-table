...
`formats` are the kind of files that are allowed to be imported. If the array is not set or is empty - it will default to _["csv"]_. <br />
...
- Type: {[`format?: FileFormat`](#FileFormat), fileName?: string}
- Default: _{format: "csv", fileName: "table_data"}_

Configuration for the exported `fileName` and its `format` .
...
<TableContainer minHeight="380">
  <ActiveTable
    files={{
      buttons: [
        {export: {format: 'csv', fileName: 'example_csv'}, text: 'Export CSV'},
        {export: {format: 'xls', fileName: 'example_xls'}, text: 'Export XLS'},
        {export: {format: 'xlsx', fileName: 'example_xlsx'}, text: 'Export XLSX'},
        {export: {format: 'ods', fileName: 'example_ods'}, text: 'Export ODS'},
        {export: {format: 'txt', fileName: 'example_txt'}, text: 'Export TXT'},
      ],
    }}
    content={[
      ['Planet', 'Diameter', 'Mass', 'Moons', 'Density'],
...
<active-table
  files='{
    "buttons": [
      {"export": {"format": "csv", "fileName": "example_csv"}},
      {"export": {"format": "xls", "fileName": "example_xls"}},
      {"export": {"format": "xlsx", "fileName": "example_xlsx"}},
      {"export": {"format": "ods", "fileName": "example_ods"}},
      {"export": {"format": "txt", "fileName": "example_txt"}}
  ]}'
></active-table>
```
...
<active-table
  files='{
    "buttons": [
      ...
      {"export": {"format": "xlsx", "fileName": "example_xlsx"}, "text": "Export XLSX"},
      {"export": {"format": "ods", "fileName": "example_ods"}, "text": "Export ODS"},
      {"export": {"format": "txt", "fileName": "txt"}, "text": "Export TXT"}
  ]}'
  content='[
    ["Planet", "Diameter", "Mass", "Moons", "Density"],
    ["Earth", 12756, 5.97, 1, 5514],
...
Formats of files that can be imported into and exported out of Active Table.
