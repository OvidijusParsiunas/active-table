...
object to define the allowed types and what they will overwrite. For browser security reasons - this method can ONLY be activated through
...
:::info
`csv` files are supported natively, however if you want to import any of the other file types - you will need to add the [`xlsx`](https://www.npmjs.com/package/xlsx) module
...
:::info
`csv` files are supported natively, however if you want to export any of the other file types - you will need to add the [`xlsx`](https://www.npmjs.com/package/xlsx) module
into your project. Please see examples [here](../../examples/files).
:::
